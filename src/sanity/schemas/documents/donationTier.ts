...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'number',
      description: 'How many students are impacted for the amount defined below. Example: If every ₹10,000 impacts 1 student, enter "1".',
      initialValue: 1,
      validation: (Rule) => Rule.required().positive(),
    }),
    defineField({
        ...
        type: 'number',
        description: 'The amount in rupees that equals one unit of impact. Example: If every ₹10,000 impacts 1 student, enter "10000".',
        initialValue: 10000,
        validation: (Rule) => Rule.required().positive(),
    }),
    defineField({
