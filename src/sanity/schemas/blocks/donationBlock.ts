...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'number',
      description: 'Sets the starting value for the donation slider. This should be the lowest possible amount a user can donate.',
      initialValue: 1000,
    ...
    defineField({
      ...
      type: 'number',
      description: 'Sets the highest value for the donation slider. This should be a significant, aspirational number.',
    ...
    defineField({
      ...
      description: 'Select the donation tiers to be used in the calculator. Tiers should be created and ordered from the lowest max amount to the highest.',
